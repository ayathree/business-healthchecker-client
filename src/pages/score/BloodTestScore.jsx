...
const BloodTestScore = () => {
     const [reportData, setReportData] = useState(null);
        ...
        const { totalBloodTestPoints = 0, mainBloodTestTotals = 0 } = reportData || {};
    return (
        <div className="bg-blue-50">
            ...
            <div className="mt-16 flex flex-col justify-center items-center">
                <div className="rounded-full border-blue-600 border-4 p-15">
                    <p className="font-bold text-9xl text-center text-blue-600">{totalBloodTestPoints}</p>
                    <hr className="border-4 border-blue-600"/>
                    <p className="font-bold text-9xl text-blue-600">{mainBloodTestTotals}</p>
                </div>
    ...
    <TypeAnimation
        sequence={[
            "Your Total Score in Business Blood Test section is",
            500,
        ]}
        wrapper="p"
        speed={50}
    ...
    <div className="flex justify-center gap-2 text-4xl font-bold">
        <span className="text-blue-600">{totalBloodTestPoints}</span>
        <span>out of</span>
        <span className="text-blue-600">{mainBloodTestTotals}</span>
    </div>
