...
const PositionScore = () => {
    ...
    const { totalPositionPoints = 0, mainPositionTotals = 0 } = reportData || {};
        ...
        <div className="bg-blue-50">
            ...
            <div className="mt-16 flex flex-col justify-center items-center">
                <div className="rounded-full border-blue-600 border-4 p-15">
                    <p className="font-bold text-9xl text-center text-blue-600">{totalPositionPoints}</p>
                    <hr className="border-4 border-blue-600"/>
                    <p className="font-bold text-9xl text-blue-600">{mainPositionTotals}</p>
                </div>
    ...
    <div className="flex justify-center gap-2 text-4xl font-bold">
        <span className="text-blue-600">{totalPositionPoints}</span>
        <span>out of</span>
        <span className="text-blue-600">{mainPositionTotals}</span>
    </div>
